...
/**
 * JDBC_03_QueryByStatement.
 *
 * @author <a href="https://github.com/Code-13/">code13</a>
 * @since 2024/7/22 13:46
 */
public class JDBC_03_QueryByStatement extends BaseJdbcRunner {
  ...
  void query() throws SQLException {
    try (Statement statement = connection.createStatement()) {
      String sql = String.format("SELECT * FROM user_balance WHERE name='%s'", "zhangsan");
