...
package io.github.code13.javase.jnaf.jdk9;
...
class StreamRunner {
  ...
  @DisplayName(
      ...
      """)
  void takeWhile() {
    Stream.of(1, 2, 3, 4, 2, 5).takeWhile(integer -> integer < 4).forEach(System.out::println);
  }
  ...
  @DisplayName(
      ...
      """)
  void dropWhile() {
    Stream.of(1, 2, 3, 4, 2, 5).dropWhile(integer -> integer < 4).forEach(System.out::println);
  }
}
