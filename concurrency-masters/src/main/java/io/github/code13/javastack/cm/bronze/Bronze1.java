...
class Bronze1 {
  ...
  void test2() {
    ...
    ArrayList<Integer> evenNumbers = IntStream.rangeClosed(1, 100).filter(n -> n % 2 == 0).collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
    ArrayList<Integer> oddNumbers = IntStream.rangeClosed(1, 100).filter(n -> n % 2 != 0).collect(ArrayList::new, ArrayList::add, ArrayList::addAll);
