...
public class EncryptedJWTTest {
  ...
  static {
    try {
      ...
      RSAPublicKeySpec publicKeySpec =
          new RSAPublicKeySpec(new BigInteger(1, mod), new BigInteger(1, exp));
      RSAPrivateKeySpec privateKeySpec =
          new RSAPrivateKeySpec(new BigInteger(1, mod), new BigInteger(1, modPriv));
  ...
  @Test
  void testEncryptAndDecrypt() throws JOSEException, ParseException {
    ...
    System.out.println(jwtString.split("\\.").length);
