 ...
 * vavr Tuples
 * <p>
 * https://docs.vavr.io/#_tuples
 *
 * <p>
 * Java is missing a general notion of tuples.
 ...
 * <p>
 * Tuples are of type Tuple1, Tuple2, Tuple3 and so on.
 * There currently is an upper limit of 8 elements.
...
class TuplesTest {
  ...
  void test2() {
    ...
    Tuple2<String, Integer> that = java11.map(
      s -> s.substring(2) + "vr",
      i -> i / 11
    );
