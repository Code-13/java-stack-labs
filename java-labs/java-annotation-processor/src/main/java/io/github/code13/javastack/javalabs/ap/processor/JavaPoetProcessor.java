...
import io.github.code13.javastack.javalabs.ap.annotation.DoctorInterface;
...
public class JavaPoetProcessor extends AbstractProcessor {
  ...
  public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
    ...
    try {
      ...
      JavaFile javaFile = JavaFile.builder("io.github.code13.javastack.javalabs.ap", helloWorld)
