...
[原文链接](http://tutorials.jenkov.com/java-nio/buffers.html "原文链接")     **作者：** Jakob Jenkov     
**译者：** airu     **校对：** 丁一
...
1. [Buffer的基本用法](#basicusage)
2. [Buffer的capacity,position和limit](#cap-pos-limit)
3. [Buffer的类型](#buffertype)
4. [Buffer的分配](#allocate)
5. [向Buffer中写数据](#writetobuffer)
6. [flip()方法](#flip)
7. [从Buffer中读取数据](#read)
8. [clear()与compact()方法](#clearandcompact)
9. [mark()与reset()方法](#markandreset)
10. [equals()与compareTo()方法](#equalsandcompareto)

### <a name="basicusage">Buffer的基本用法</a>
