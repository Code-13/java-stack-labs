      ...
      <Skeleton loading={loading}>
        ...
        >
          {data && data.github ? (
            <List.Item
              actions={[
                <a key="unbind" onClick={() => handleUnbind('github')}>
                  解绑
                </a>,
              ]}
            >
              <List.Item.Meta
                avatar={
                  <Badge
                    count={<GithubOutlined className={githubBadgeClassName} />}
                    offset={[0, 44]}
                  >
                    <img
                      className={socialAvatarClassName}
            ...
            <List.Item
              actions={[
                <a key="bind" href="/oauth2/authorization/github-idp?action=bind">
                  绑定
                </a>,
              ]}
            >
