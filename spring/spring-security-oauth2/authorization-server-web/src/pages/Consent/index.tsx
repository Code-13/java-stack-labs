...
const Consent: React.FC = () => {
  ...
  if (consentInfo?.previouslyApprovedScopes) {
    ...
    previouslyApprovedScopeOptionsSelected = consentInfo.previouslyApprovedScopes.map(
      ...
      <div className={contentClassName}>
        <div className={logoTopClassName}>
          <div className={logoHeaderClassName}>
            ...
            <span className={logoTitleClassName}>Authorization Server</span>
          </div>
          <div className={logoDescClassName}>Authorization Server</div>
        </div>
                  ...
                  render: ({ form }) => {
                    return [
                      <Button
                        key="submit"
                        type="primary"
                        onClick={() => submit(form?.getFieldValue('scopes'))}
                      >
                        同意
                      </Button>,
            ...
            <div>
              <p>
                <small>
                  ...
                  <br />
                  如果您不同意，请单击
                  <span className="font-weight-bold text-primary">取消授权</span>
                  ，将不会为上述应用程序提供任何您的信息。
                </small>
              </p>
            </div>
